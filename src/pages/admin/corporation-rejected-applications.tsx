...
export default function CorporationRejectedApplications() {
  ...
  const loadRejectedApplications = () => {
    try {
      ...
      const rejectedApps = storedApplications.filter(app => app.corporationStatus === 'rejected')
  ...
  return (
    <>
      <Head>
        <title>Corporation Committee - Rejected Applications | Maharashtra WRD</title>
        <meta name="description" content="View rejected applications by Corporation Committee" />
      </Head>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      {applications.length} application{applications.length !== 1 ? 's' : ''} rejected by Corporation Committee
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center text-red-300">
                          <Calendar className="w-4 h-4 mr-2" />
                          <span>Corp Rejected: {app.corporationActionDate}</span>
                        </div>
                      </div>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white/10 backdrop-blur-md border border-red-200/20 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="sticky top-0 bg-white/10 backdrop-blur-md border-b border-red-200/20 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-red-300 text-sm">Rejected by Corporation Committee</p>
                  </div>
                  <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-red-50/10 border border-red-200/20 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-white font-medium">{selectedApp.corporationActionDate}</p>
                    </div>
                    <div>
                      <p className="text-gray-400">Current Stage:</p>
                      <p className="text-red-300 font-medium">Process Ended</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Corporation Committee Rejection */}
                <div className="bg-red-50/10 border border-red-200/20 rounded-lg p-4">
                  <h4 className="font-bold text-white mb-3 flex items-center">
                    <XCircle className="w-5 h-5 mr-2 text-red-400" />
                    Corporation Committee Decision
                  </h4>
                  <div className="space-y-3">
                    <div>
                    ...
                    <div className="bg-red-100/10 border border-red-300/20 rounded p-3">
                      <p className="text-red-300 text-sm">
                        ...
                        This application was approved by Circle Committee but rejected by Corporation Committee. The process has ended.
                      </p>
                    </div>
                  </div>
                </div>
