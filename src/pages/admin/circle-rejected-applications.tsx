...
export default function CircleRejectedApplications() {
  ...
  useEffect(() => {
    ...
    if (admin.userType !== 'circle-committee') {
      toast.error('Access denied. Circle Committee access required.')
  ...
  const loadRejectedApplications = () => {
    try {
      ...
      const rejectedApps = storedApplications.filter(app => app.circleStatus === 'rejected')
  ...
  return (
    <>
      <Head>
        <title>Circle Committee - Rejected Applications | Maharashtra WRD</title>
        <meta name="description" content="View rejected applications by Circle Committee" />
      </Head>
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white">Circle Committee</h1>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      {applications.length} application{applications.length !== 1 ? 's' : ''} rejected by Circle Committee
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center text-red-300">
                          <Calendar className="w-4 h-4 mr-2" />
                          <span>Rejected: {app.circleActionDate}</span>
                        </div>
                      </div>
                      ...
                      {app.circleRemarks && (
                        <div className="bg-red-50/10 border border-red-200/20 rounded-lg p-3">
                          ...
                          <p className="text-red-200 text-sm line-clamp-2">
                            {app.circleRemarks.length > 80 
                              ? `${app.circleRemarks.substring(0, 80)}...` 
                              : app.circleRemarks
                            }
                          </p>
                        </div>
              ...
              <div className="sticky top-0 bg-white/10 backdrop-blur-md border-b border-red-200/20 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-red-300 text-sm">Rejected by Circle Committee</p>
                  </div>
                  <button
                ...
                <div className="bg-red-50/10 border border-red-200/20 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-white font-medium">{selectedApp.circleActionDate}</p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-red-100/10 border border-red-300/20 rounded p-3">
                      <p className="text-red-300 text-sm">
                        ...
                        This application has been rejected and the process has ended. The applicant can submit a new application if they wish to reapply.
                      </p>
                    </div>
                  </div>
                </div>
